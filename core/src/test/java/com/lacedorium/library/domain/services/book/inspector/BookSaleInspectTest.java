...
class BookSaleInspectTest {
    private BorrowLineRepositoryStub repoBorrowLine;
    private BookSaleInspect inspector;
    private Book book;

    @BeforeEach
    void setUp() {
        repoBorrowLine = new BorrowLineRepositoryStub();
        inspector = new BookSaleInspect(repoBorrowLine);
    ...
    @Test
    void shouldFalseWhenTheStockIsNotEnough() {
        book.changeStock(2);
    ...
    @Test
    void shouldFalseWhenTheStockIsNotEnoughWithBorrows() {
        repoBorrowLine.attach(Ref.BorrowLineJohnQuixote);
